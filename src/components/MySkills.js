...
const MySkills = () => {
  return (
        ...
        <div name='skills' className='bg-[#0a192f] text-gray-300 py-4 w-full h-screen md:flex justify-center items-center'>
            <div className='max-w-[1000px] mx-auto p-4 md:flex flex-auto justify-center w-full'>
                <div>
